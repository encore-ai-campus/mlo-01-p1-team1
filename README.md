...
### 프로젝트 소개
- 기존 중고차 사이트에 분리되어 있는 차량 정보와 FAQ를 차종·카테고리별로 통합하여, 차량 구매에 필요한 정보를 한눈에 제공하는 서비스다. 구매 후에는 차량 보수·관리 관련 FAQ를 이메일이나 문자로 안내한다.

### 프로젝트 필요성(배경)
- 차량 정보와 FAQ가 따로 있어 사용자가 필요한 정보를 찾기 어렵고, 구매 후 차량 관리 정보도 놓치기 쉽다. 이를 통합·맞춤 제공하여 구매 판단과 사후 관리의 편의성을 높이고자 한다.
...
| 백업 로그 관리 | 적재 시 백업·검증·업로드 결과를 기록하고 logrotate 및 중앙 로그 전송 구성 |
| `이형인` |  |
...
PPT 링크 : https://www.miricanvas.com/v2/ko/design2/v/61671001-af4b-4752-94fc-f6811cfc7c7c
